  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between">
        <Link to="/" className="gradient-text font-heading text-xl font-bold tracking-tight">
          AllblogsIdea
        </Link>
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1 px-4 py-2 text-sm font-medium transition-colors hover:text-foreground ${
                location.pathname.startsWith("/category") ? "text-foreground" : "text-muted-foreground"
              }`}
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/blog" className="hidden sm:inline-flex btn-gradient text-sm py-2 px-5">
            Subscribe
          </Link>
          <button
